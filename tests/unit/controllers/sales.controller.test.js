...
const { allSalesArrayMock, registeredProducts, allSalesMock } = require('../../mocks/salesMock');
...
describe('Teste para a camada de Controller', () => {
  ...
  describe('Testa o funcionamento da função registerSales', () => {
    ...
    it('Testa se retorna um erro ao tentar cadastra o produto', async () => {
      ...
      sinon.stub(salesService, 'registerSales').resolves({ type: 'NOT_FOUND', message: 'Product not found' });
